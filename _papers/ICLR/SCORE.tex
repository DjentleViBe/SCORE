...
\caption{Distribution of starting notes for musical measures, used to select initial tokens at inference time for more consistent generation.}
  \label{fig:firstnote}
\end{figure}
...
The concept of the repetition penalty introduced in \citep{reppenalty} uses penalised sampling
at inference time.
...
We define the softmax distribution with temperature $\tau > 0$ as:
\begin{equation}
P_{b,t}(v)
=
...
We define the total probability mass assigned to penalized tokens at timestep $t$ as:
\begin{equation}
S_{b,t}
=
...
\begin{figure}[H]
  ...
  \caption{KL divergence between generated and training distributions of \textbf{(a)} musical notes, 
