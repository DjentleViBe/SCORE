...
%
\author{%
Anonymous Author(s)\thanks{Affiliation withheld for double-blind review}%
...
%
\authorshort{Anonymous Author(s)} %or, e.g., \authorshort{Author1 et al}
\titleshort{Tokenization-Aware Transformer for Music}
...
which captures segmentation between different musical phrases. The given approach enables 
efficient batching of variable length musical phrases while preserving their contextual coherence.
\end{abstract}
%
\begin{keywords}
motif generation, symbolic music generation, transformers, sequence modelling, KL divergence.
\end{keywords}
}]
\saythanks{}
...
Table~\ref{tab:kldiv} summarizes the divergence values, and Figures~\ref{fig:noteskl}-\ref{fig:beattypekl} visualize the results.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\linewidth]{0_test_all_T10_compareprobabilitynotes.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\linewidth]{0_test_all_T10_compareprobabilitybeats.pdf}
  \caption{KL divergence for beat tokens with start token 15528, showing the model preserves rhythmic structure.}
\label{fig:beatskl}
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\linewidth]{0_test_all_T10_compareprobabilitybeattype.pdf}
  \caption{KL divergence for beat types with start token 15528, demonstrating correct modeling of musical subdivisions.}
...
\begin{figure}[H]
  \centering
  \includegraphics[trim={20 230 0 100}, clip, width=1.0\linewidth]{test_all.pdf}
  \caption{Four generated musical measures demonstrating the model's ability to maintain musical coherence and expressive details at TEMPERATURE 0.7.}
\label{fig:sheet}
\end{figure}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
