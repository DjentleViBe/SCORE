...
\begin{tabular}{cccccc}
  \hline
  \multicolumn{1}{|c|}{Header 1} & \multicolumn{1}{|c|}{27051} & \multicolumn{1}{|c|}{Header 3} & \multicolumn{1}{|c|}{27051} & \multicolumn{1}{|c|}{Header3} & \multicolumn{1}{|c|}{27051} \\
   \hline
...
\begin{tabular}{cc}
  \hline
  \multicolumn{1}{|c|}{Header 1} & \multicolumn{1}{|c|}{27052}\\
   \hline
...
\begin{figure}[H]
  \centering
\includegraphics[clip, width=0.8\linewidth]{dec_RPE_ann_CB_Large_startprobability.pdf}
...
\begin{figure}[H]
  \centering
\includegraphics[clip, width=0.7\linewidth]{dec_RPE_ann_CB_Large_trainingaccentprobability.pdf}
...
\caption{Note and beat occurrences of training data and inference}
  \label{fig:note}
\end{figure}
...
\caption{Inference results showing 4 musical measures}
  \label{fig:inference}
\end{figure}
The model implementation is available on GitHub \cite{SC0RE}.
