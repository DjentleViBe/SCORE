...
KL divergence is used at inference as an unsupervised validation to assess model consistency without human evaluation
\end{abstract}
...
represented as an integer index. In this paper, a note is represented by multiplying the guitar's fret number by the string number to 
...
The formula for note encodings, with a 6 string guitar and 23 notes per string, is given by: 
\begin{align}
...
\caption{Test results showing 5 musical measures with TEMPERATURE = 0.7}
  \label{fig:inference}
\end{figure}
