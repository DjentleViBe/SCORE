...
The reported loss values were computed as the mean over five independent training runs after 100 epochs for hyper-parameter values listen in Appendix~\eqref{app:D}:\\
\begin{table}[htbp]
 \centering
\begin{tabular}{ccc}
\hline
  ...
  \hline
  \multicolumn{1}{|c|}{Cross Entropy} & \multicolumn{1}{|c|}{1.5012} & \multicolumn{1}{|c|}{0.0542}\\
  \hline
  \multicolumn{1}{|c|}{Repetition} & \multicolumn{1}{|c|}{0.0327} & \multicolumn{1}{|c|}{0.001}\\
  \hline
  \multicolumn{1}{|c|}{Sequence} & \multicolumn{1}{|c|}{0.1996} & \multicolumn{1}{|c|}{3e-7}\\
  \hline
  \multicolumn{1}{|c|}{Total} & \multicolumn{1}{|c|}{1.7336} & \multicolumn{1}{|c|}{0.0541}\\
  \hline
  \multicolumn{1}{|c|}{Validation} & \multicolumn{1}{|c|}{1.9701} & \multicolumn{1}{|c|}{0.1034}\\
    \hline
\end{tabular}
\captionsetup{type=table}
\caption{Loss values}
...
\begin{figure}[H]
  \centering
\includegraphics[clip, width=0.8\linewidth]{compareprobabilitynotes.pdf}
